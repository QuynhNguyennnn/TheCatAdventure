...
public class SkeletonBossHealthManagement : MonoBehaviour
{
    public int currentHealth;
    public int maxHealth;
    SkeletonBossController controller;
    [SerializeField]
    private GameObject necklaceMap2;
    ...
    void Start()
    {
        controller = GetComponent<SkeletonBossController>();
