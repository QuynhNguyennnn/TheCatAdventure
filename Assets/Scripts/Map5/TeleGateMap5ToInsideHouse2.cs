...
public class TeleGateMap5ToInsideHouse2 : MonoBehaviour
{
    ...
    void Update()
    {
        if (isClose)
        {
            ...
            if (wait <= 0)
            {
                ...
                {
                    PlayerPrefs.SetFloat("PlayerPositionX", 0.2f);
                    PlayerPrefs.SetFloat("PlayerPositionY", -2.2f);
                    PlayerPrefs.SetFloat("PlayerPositionZ", 0);

                    //PlayerPrefs.SetString("Type", "Map5_InsideHouse2");

                    SceneManager.LoadScene("InsideHouse2_End");
                }
            }
        }
